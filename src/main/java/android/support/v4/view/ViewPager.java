                ...
                if (lp.isDecor) {
                    ...
                    switch (vgrav) {
                        case 16:
                            ...
                            break;
                        case com.baidu.mapapi.map.MapView.LayoutParams.TOP /*48*/:
                            childTop = paddingTop;
                            paddingTop += child.getMeasuredHeight();
                            break;
                        case com.baidu.mapapi.map.MapView.LayoutParams.BOTTOM /*80*/:
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    velocityTracker.computeCurrentVelocity(LocationClientOption.MIN_SCAN_SPAN, (float) this.mMaximumVelocity);
