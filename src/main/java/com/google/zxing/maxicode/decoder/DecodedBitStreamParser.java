        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (!result.toString().startsWith("[)>\u001e01\u001d")) {
                    result.insert(0, new StringBuilder(String.valueOf(postcode)).append(GS).append(country).append(GS).append(service).append(GS).toString());
                    break;
                }
                result.insert(9, new StringBuilder(String.valueOf(postcode)).append(GS).append(country).append(GS).append(service).append(GS).toString());
                break;
            case 4:
