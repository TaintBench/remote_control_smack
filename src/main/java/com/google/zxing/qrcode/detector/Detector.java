...
public class Detector {
    ...
    /* access modifiers changed from: protected */
    public DetectorResult processFinderPatternInfo(FinderPatternInfo info) throws NotFoundException, FormatException {
    ...
    private float sizeOfBlackWhiteBlackRun(int fromX, int fromY, int toX, int toY) {
        ...
        diffX = (toX + xstep) - fromX;
        diffY = toY - fromY;
        return (float) Math.sqrt((double) ((diffX * diffX) + (diffY * diffY)));
    }

    /* access modifiers changed from: protected */
    public AlignmentPattern findAlignmentInRegion(float overallEstModuleSize, int estAlignmentX, int estAlignmentY, float allowanceFactor) throws NotFoundException {
