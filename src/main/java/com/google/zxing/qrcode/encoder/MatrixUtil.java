...
final class MatrixUtil {
    private static final int[][] HORIZONTAL_SEPARATION_PATTERN = new int[][]{new int[8]};
    ...
    private static final int[][] VERTICAL_SEPARATION_PATTERN = new int[][]{new int[1], new int[1], new int[1], new int[1], new int[1], new int[1], new int[1]};
