...
public final class Code93Reader extends OneDReader {
    ...
    private static final int[] CHARACTER_ENCODINGS = new int[]{276, 328, 324, 322, 296, 292, 290, 336, 274, 266, 424, 420, 418, 404, 402, 394, 360, 356, 354, 308, 282, 344, 332, 326, MKEvent.ERROR_PERMISSION_DENIED, 278, 436, 434, 428, 422, 406, 410, 364, 358, 310, 314, 302, 468, 466, 458, 366, 374, 430, 294, 474, 470, 306, 350};
    ...
    private static int toPattern(int[] counters) {
        ...
        for (i = 0; i < max; i++) {
            ...
            if ((scaledShifted & MotionEventCompat.ACTION_MASK) > TransportMediator.KEYCODE_MEDIA_PAUSE) {
                scaledUnshifted++;
            }
