...
public class MapGoogle extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mapdata = new MapDataBean(this, this.strSelect_Name, this.strSelect_Pairnum);
        this.mapdata.UpdataJason(this.hostname, "google");
    }
}
