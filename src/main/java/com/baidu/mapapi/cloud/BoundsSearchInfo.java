...
public class BoundsSearchInfo {
    ...
    public String a() {
        ...
        if (this.bounds != null) {
            stringBuilder.append("&bounds=").append(((double) this.bounds.leftBottom.getLatitudeE6()) / 1000000.0d).append(',').append(((double) this.bounds.leftBottom.getLongitudeE6()) / 1000000.0d);
            stringBuilder.append(';').append(((double) this.bounds.rightTop.getLatitudeE6()) / 1000000.0d).append(',').append(((double) this.bounds.rightTop.getLongitudeE6()) / 1000000.0d);
        }
